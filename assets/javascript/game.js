$(document).ready(function() {
  ...
  for (var i = 0; i < number1.length; i++) {
    ...
    imageCrystal1.attr("src", "./assets/images/greenCrystal.jpg");
  ...
  for (var i = 0; i < number2.length; i++) {
    ...
    imageCrystal2.attr("src", "./assets/images/blueCrystal.jpg");
  ...
  for (var i = 0; i < number3.length; i++) {
    ...
    imageCrystal3.attr("src", "./assets/images/redCrystal.jpg");
  ...
  for (var i = 0; i < number4.length; i++) {
    ...
    imageCrystal4.attr("src", "./assets/images/purpleCrystal.jpg");
